...
plan <- drake_plan(
  ...
  nhdplus_net = get_net(nhdplus_gdb_path, prj),
  nhdhr_hu02 = c("01", "02"),
  nhdhr_dir = "data/nhdplushr",
  nhdhr_path = download_nhdhr(nhdhr_dir, nhdhr_hu02),
  nhdhr_raw = get_nhdplushr(nhdhr_path, file.path(nhdhr_dir, "nhdplushr_raw.gpkg"), layers = "NHDFlowline"),
  nhdhr_gpkg = nhdhr_mod(nhdhr_raw, file.path(nhdhr_dir, "nhdplushr.gpkg"), force_terminal = TRUE),
  nhdhr_net = get_net(nhdhr_gpkg, prj),
  wbd_dir = "data/wbd",
