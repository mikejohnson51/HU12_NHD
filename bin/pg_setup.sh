...
ogr2ogr -overwrite -progress -f "PostGreSQL" PG:"host=localhost dbname=nhd" -nlt PROMOTE_TO_MULTI -lco "GEOMETRY_NAME=the_geom" -a_srs EPSG:5070 out/wbd_viz.gpkg wbd_viz

ogr2ogr -overwrite -progress -f "PostGreSQL" PG:"host=localhost dbname=nhd" -nlt PROMOTE_TO_MULTI -lco "GEOMETRY_NAME=the_geom" -a_srs EPSG:5070 out/wbd_viz.gpkg net
...
ogr2ogr -overwrite -progress -f "PostGreSQL" PG:"host=localhost dbname=nhd" -nlt PROMOTE_TO_MULTI -lco "GEOMETRY_NAME=the_geom" -a_srs EPSG:5070 out/wbd_viz.gpkg wbd_matched

ogr2ogr -overwrite -progress -f "PostGreSQL" PG:"host=localhost dbname=nhd" -nlt PROMOTE_TO_MULTI -lco "GEOMETRY_NAME=the_geom" -a_srs EPSG:5070 out/wbd_viz.gpkg wbd_grouped
